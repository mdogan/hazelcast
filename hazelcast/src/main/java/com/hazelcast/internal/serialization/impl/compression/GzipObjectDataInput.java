 ...
 *
 */
public class GzipObjectDataInput extends GZIPInputStream implements CompressionObjectDataInput {
    ...
    public GzipObjectDataInput(InputStream in, InternalSerializationService service, ByteOrder byteOrder) throws IOException {
        super(in, 1 << 20);
        this.service = service;
        this.byteOrder = byteOrder;
    }

    public GzipObjectDataInput(ObjectDataInput in) throws IOException {
