 ...
 */
public class GzipObjectDataOutput extends GZIPOutputStream implements CompressionObjectDataOutput {
    ...
    public GzipObjectDataOutput(OutputStream out, InternalSerializationService service, ByteOrder byteOrder)
            throws IOException {
        super(out, 1 << 20);
    ...
    public GzipObjectDataOutput(ObjectDataOutput out) throws IOException {
