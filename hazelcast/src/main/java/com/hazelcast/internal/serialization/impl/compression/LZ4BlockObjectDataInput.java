 ...
 *
 */
public class LZ4BlockObjectDataInput extends LZ4BlockInputStream implements CompressionObjectDataInput {
    ...
    public LZ4BlockObjectDataInput(InputStream in, InternalSerializationService service, ByteOrder byteOrder) {
        super(in, LZ4Factory.fastestJavaInstance().fastDecompressor());
        this.service = service;
        this.byteOrder = byteOrder;
    }

    public LZ4BlockObjectDataInput(ObjectDataInput in) {
