 ...
 *
 */
public class LZ4FrameObjectDataInput extends LZ4FrameInputStream implements ObjectDataInput, DataReader {
    ...
    public LZ4FrameObjectDataInput(InputStream in, InternalSerializationService service, ByteOrder byteOrder) throws IOException {
        super(in);
        this.service = service;
        this.byteOrder = byteOrder;
    }

    public LZ4FrameObjectDataInput(ObjectDataInput in) throws IOException {
