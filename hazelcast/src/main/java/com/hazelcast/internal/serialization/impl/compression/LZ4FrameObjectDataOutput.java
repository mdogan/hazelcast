 ...
 */
public class LZ4FrameObjectDataOutput extends LZ4FrameOutputStream implements ObjectDataOutput, DataWriter {
    ...
    public LZ4FrameObjectDataOutput(OutputStream out, InternalSerializationService service, ByteOrder byteOrder)
            throws IOException {
        super(out, BLOCKSIZE.SIZE_1MB);
        this.service = service;
        this.byteOrder = byteOrder;
    }

    public LZ4FrameObjectDataOutput(ObjectDataOutput out) throws IOException {
