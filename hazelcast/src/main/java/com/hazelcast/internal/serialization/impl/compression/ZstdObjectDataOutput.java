 ...
 */
public class ZstdObjectDataOutput extends ZstdOutputStream implements CompressionObjectDataOutput {
    ...
    public ZstdObjectDataOutput(OutputStream out, InternalSerializationService service, ByteOrder byteOrder)
            throws IOException {
        super(out);
    ...
    public ZstdObjectDataOutput(ObjectDataOutput out) throws IOException {
