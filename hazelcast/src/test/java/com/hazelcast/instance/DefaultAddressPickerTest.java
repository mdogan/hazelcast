...
public class DefaultAddressPickerTest {
    ...
    private String preferIPv4Prop;
    private String preferIPv6Prop;

    @Before
    public void setup() {
        preferIPv4Prop = System.getProperty(DefaultAddressPicker.PREFER_IPV4_STACK);
        preferIPv6Prop = System.getProperty(DefaultAddressPicker.PREFER_IPV6_ADDRESSES);
    ...
    public void tearDown() {
        ...
        if (preferIPv4Prop != null) {
            System.setProperty(DefaultAddressPicker.PREFER_IPV4_STACK, preferIPv4Prop);
        }
        if (preferIPv6Prop != null) {
            System.setProperty(DefaultAddressPicker.PREFER_IPV6_ADDRESSES, preferIPv6Prop);
        }
    }
    ...
    private static InetAddress findIPv6NonLoopbackInterface() {
        System.setProperty(DefaultAddressPicker.PREFER_IPV6_ADDRESSES, "true");
